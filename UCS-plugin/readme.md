...
### This release of the plugin requires Python SDK 0.8.3.  This is an older python SDK so it's included in this repo for your convenience.
...
# Screenshots
Nagios Map View showing a single pod expanded
